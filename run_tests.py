...
def run_all_tests():
    ...
    import os
    if os.path.exists("BUP_CSE_FEST_2026_Preli_Public_Sample_Cases.json"):
        ...
        print("[SKIP] BUP_CSE_FEST_2026_Preli_Public_Sample_Cases.json not found. Skipping public sample cases.")
